...
public class PlayerData
{
	...
	static public void NewSave()
	{
        ...
        m_Instance.rank = 0;
        // NewSave mutates the existing instance, so this has to be reset explicitly or a player who
        // deletes their data from the settings popup never gets the tutorial back.
