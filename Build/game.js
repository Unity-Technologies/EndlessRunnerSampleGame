...
function startUnity(){
  ...
  var framework = require('./Build.wasm.framework.unityweb.js');
...
if(platform == "devtools") {
  gameInstance.Module["wasmPath"] = 'Build.wasm.code.unityweb.bin';
  gameInstance.Module["preLoaDataPath"] = 'Build.data.unityweb.bin';
